...
export class ModifySubmissionComponent implements OnInit {
  ...
  constructor(private formBuilder: FormBuilder, private submitService: SubmitService, private snackBar: MatSnackBar, private router: Router, private route: ActivatedRoute) {
  ...
  getSubmissionData(id: string): void {
    this.submitService.getSubmissionById(id).subscribe((submission: Submission) => {
